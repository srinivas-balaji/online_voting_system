...
<title>Polling System:Voting Page</title>
...
function redir() 
{
    window.location = "http://localhost/online_voting_system/logout.php";
  }
...
<body bgcolor="tan">
<center>
<b><font color = "brown" size="6">Polling System</font></b></center><br><br>
<body>
<div id="page">
<div id="header">
  <h1>CURRENT POLLS</h1>
  <a href="index.php">Home</a> | <a href="vote.php">Current Polls</a> | <a href="manage-profile.php">Manage My Profile</a> | <a href="logout.php">Logout</a>
</div>
<div class="refresh">
</div>
<div id="container">
...
echo "<td><input type='radio' name='vote' value='$row[candidate_name]' onclick='getVote(this.value); redir()' /></td>";
echo "</tr>";
}
...
<div id="footer"> 
  <div class="bottom_addr">&copy; 2020 Simple PHP Polling System. All Rights Reserved</div>
</div>
</div>
</body>
    </body>
