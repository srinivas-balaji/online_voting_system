  ...
  <div id="topbar" class="hoc clear"> 
    ...
    <div class="fl_right">
      <ul class="nospace inline pushright">
        ...
        <li><i class="fa fa-envelope-o"></i> helpline@example.com </li>
      </ul>
    </div>
...
width='<?php if(isset($_POST['Submit'])){ if ($candidate_4 || $candidate_3 || $candidate_2 || $candidate_1 != 0){echo(100*round($candidate_1/($candidate_4+$candidate_3+$candidate_2+$candidate_1),2));}} ?>'
height='10'>
<?php if(isset($_POST['Submit'])){ if ($candidate_4 || $candidate_3 || $candidate_2 || $candidate_1 != 0){echo(100*round($candidate_1/($candidate_4+$candidate_3+$candidate_2+$candidate_1),2));}} ?>% of <?php if(isset($_POST['Submit'])){echo $totalvotes;} ?> total votes
...
width='<?php if(isset($_POST['Submit'])){ if ($candidate_4 || $candidate_3 || $candidate_2 || $candidate_1 != 0){echo(100*round($candidate_2/($candidate_4+$candidate_3+$candidate_2+$candidate_1),2));}} ?>'
height='10'>
<?php if(isset($_POST['Submit'])){ if ($candidate_4 || $candidate_3 || $candidate_2 || $candidate_1 != 0){echo(100*round($candidate_2/($candidate_4+$candidate_3+$candidate_2+$candidate_1),2));}} ?>% of <?php if(isset($_POST['Submit'])){echo $totalvotes;} ?> total votes
...
<img src="images/candidate-3.gif"
width='<?php if(isset($_POST['Submit'])){ if ($candidate_4 || $candidate_3 || $candidate_2 || $candidate_1 != 0){echo(100*round($candidate_3/($candidate_4+$candidate_3+$candidate_2+$candidate_1),2));}} ?>'
height='10'>
<?php if(isset($_POST['Submit'])){ if ($candidate_4 || $candidate_3 || $candidate_2 || $candidate_1 != 0){echo(100*round($candidate_3/($candidate_4+$candidate_3+$candidate_2+$candidate_1),2));}} ?>% of <?php if(isset($_POST['Submit'])){echo $totalvotes;} ?> total votes
<br>votes <?php if(isset($_POST['Submit'])){ echo $candidate_3;} ?>
    
<br>
<br>
<?php if(isset($_POST['Submit'])){ echo $candidate_name_4;} ?>:<br>
<img src="images/candidate-4.gif"
width='<?php if(isset($_POST['Submit'])){ if ($candidate_4 || $candidate_3 || $candidate_2 || $candidate_1 != 0){echo(100*round($candidate_4/($candidate_4+$candidate_3+$candidate_2+$candidate_1),2));}} ?>'
height='10'>
<?php if(isset($_POST['Submit'])){ if ($candidate_4 || $candidate_3 || $candidate_2 || $candidate_1 != 0){echo(100*round($candidate_4/($candidate_4+$candidate_3+$candidate_2+$candidate_1),2));}} ?>% of <?php if(isset($_POST['Submit'])){echo $totalvotes;} ?> total votes
