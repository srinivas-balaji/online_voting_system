...
<?php
    ...
    if (isset($_POST['update'])){
        ...
        $sql = mysqli_query($conn, "UPDATE tbMembers SET first_name='$myFirstName', last_name='$myLastName', email='$myEmail' WHERE member_id = '$myId'" )
                or die( mysqli_error() );
  ...
  <div id="topbar" class="hoc clear"> 
    ...
    <div class="fl_right">
      <ul class="nospace inline pushright">
        ...
        <li><i class="fa fa-envelope-o"></i> electioncommission@example.com </li>
      </ul>
    </div>
    <!-- ################################################################################################ -->
  </div>
    ...
    <ul class="nospace group">
      ...
      <li class="one_half">
        <blockquote>
            ...
            <table align="center">
            <tr><td  style="background-color:#0000ff"  >First Name:</td><td style="background-color:#0000ff"  ><input  style="color:#000000"; type="text" font-weight:bold; name="firstname" maxlength="15" value="" required></td></tr>

            <tr><td style="background-color:#bf00ff">Last Name:</td><td style="background-color:#bf00ff"><input style="color:#000000";  type="text" font-weight:bold; name="lastname" maxlength="15" value="" required></td></tr>

            <tr><td style="background-color:#0000ff" >Email Address:</td><td style="background-color:#0000ff"><input style="color:#000000";  type="text" font-weight:bold; name="email" maxlength="100" value="" required></td></tr>

            

            <tr><td style="background-color:#0000ff" >&nbsp;</td><td style="background-color:#0000ff" ><input style="color:#ff0000";  type="submit" name="update" value="Update Profile" required></td></tr>
